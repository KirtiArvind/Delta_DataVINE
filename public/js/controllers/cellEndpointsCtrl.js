app.controller('cellEndpointsCtrl', function ($scope, $state) {
    ...
    $scope.nodeDevicesOptions = {
        columnDefs: [
            ...
            { field: 'Device Info' , cellTemplate: '<div class="ui-grid-cell-contents"><button type="button" class="btn btn-xs btn-primary cellBtn" ng-click="grid.appScope.vm.openNetworkStatistics(row)"><i class="glyphicon glyphicon-info-sign"></i></button></div>' }
        ],
    ...
    vm.openNetworkStatistics = function open(size) {
