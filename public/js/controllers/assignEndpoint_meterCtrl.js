...
app.controller('assignEndpoint_meterCtrl', ['$scope', 'fileUpload',  '$modalInstance' ,'$uibModal', function ($scope, fileUpload, $modalInstance, $uibModal) {
